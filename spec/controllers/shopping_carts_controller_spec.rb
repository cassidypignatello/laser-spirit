...
RSpec.describe ShoppingCartsController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all shopping_carts as @shopping_carts" do
      ...
      expect(assigns(:shopping_carts)).to eq([shopping_cart])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new shopping_cart as @shopping_cart" do
      ...
      expect(assigns(:shopping_cart)).to be_a_new(ShoppingCart)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created shopping_cart as @shopping_cart" do
        ...
        expect(assigns(:shopping_cart)).to be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved shopping_cart as @shopping_cart" do
        post :create, {:shopping_cart => invalid_attributes}, valid_session
        expect(assigns(:shopping_cart)).to be_a_new(ShoppingCart)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested shopping_cart" do
        shopping_cart = ShoppingCart.create! valid_attributes
        put :update, {:id => shopping_cart.to_param, :shopping_cart => new_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns the shopping_cart as @shopping_cart" do
        shopping_cart = ShoppingCart.create! valid_attributes
        put :update, {:id => shopping_cart.to_param, :shopping_cart => invalid_attributes}, valid_session
        expect(assigns(:shopping_cart)).to eq(shopping_cart)
      end
